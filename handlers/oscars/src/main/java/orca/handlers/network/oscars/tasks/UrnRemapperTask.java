package orca.handlers.network.oscars.tasks;
...
/**
 * Remap URNs based on a property file For now the property file has one property with an even number of comma-separated
 * URNs. The odd-ones are 'from', the even ones are 'to'
 * 
 * @author ibaldin
 *
 */
