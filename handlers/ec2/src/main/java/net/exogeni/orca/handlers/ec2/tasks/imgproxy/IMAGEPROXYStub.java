...
public class IMAGEPROXYStub extends org.apache.axis2.client.Stub {
    ...
    public RegisterImageResponse RegisterImage(
            ...
            RegisterImage param18) throws java.rmi.RemoteException
        ...
        try {
            ...
            java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(),
                    RegisterImageResponse.class, getEnvelopeNamespaces(_returnEnv));
            _messageContext.getTransportOut().getSender().cleanup(_messageContext);
            return (RegisterImageResponse) object;
    ...
    public void startRegisterImage(
            ...
            RegisterImage param18,

            final IMAGEPROXYCallbackHandler callback)
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.Callback() {
            public void onComplete(org.apache.axis2.client.async.AsyncResult result) {
                ...
                callback.receiveResultRegisterImage((RegisterImageResponse) object);
            }
    ...
    private org.apache.axiom.om.OMElement toOM(RegisterImage param,
            boolean optimizeContent) {

        return param.getOMElement(RegisterImage.MY_QNAME,
                org.apache.axiom.om.OMAbstractFactory.getOMFactory());

    }

    private org.apache.axiom.om.OMElement toOM(RegisterImageResponse param,
            boolean optimizeContent) {

        return param.getOMElement(RegisterImageResponse.MY_QNAME,
                org.apache.axiom.om.OMAbstractFactory.getOMFactory());

    }

    private org.apache.axiom.om.OMElement toOM(Exception0 param,
            boolean optimizeContent) {

        return param.getOMElement(Exception0.MY_QNAME,
                org.apache.axiom.om.OMAbstractFactory.getOMFactory());

    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
                                                          RegisterImage param, boolean optimizeContent) {
        org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();

        emptyEnvelope.getBody()
                .addChild(param.getOMElement(RegisterImage.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(org.apache.axiom.om.OMElement param, java.lang.Class type,
        ...
        try {
            ...
            if (RegisterImage.class.equals(type)) {

                return RegisterImage.Factory
                        .parse(param.getXMLStreamReaderWithoutCaching());

            }

            if (RegisterImageResponse.class.equals(type)) {

                return RegisterImageResponse.Factory
                        .parse(param.getXMLStreamReaderWithoutCaching());

            }

            if (Exception0.class.equals(type)) {

                return Exception0.Factory
                        .parse(param.getXMLStreamReaderWithoutCaching());
