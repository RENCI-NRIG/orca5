...
public class NEucaAddPropertyInfFileTask extends OrcaAntTask {
    ...
    /*
     * private void addProperty_Ini(){ System.out.println("PRUTH: this.section = " + this.section + ", this.key = " +
     * this.key + ", this.value = " + this.value);
     * 
     * Ini ini = null; if (this.file.equals(this.userdataOld)){ System.out.println("PRUTH: reading userdata from file "
     * + this.file); ini = new Ini(new File(this.file)); } else {
     * System.out.println("PRUTH: using userdata from userdataOld string"); ini = new Ini(new
     * ByteArrayInputStream(this.userdataOld.getBytes())); }
     * 
     * if(this.section != null && this.key != null && this.value != null){
     * System.out.println("PRUTH: adding this.section = " + this.section + ", this.key = " + this.key +
     * ", this.value = " + this.value); ini.put(this.section,this.key,this.value); } else {
     ...
     */
    /*
     * private void addProperty(){ System.out.println("PRUTH: this.section = " + this.section + ", this.key = " +
     * this.key + ", this.value = " + this.value);
     * 
     * if (this.file.equals(this.userdataOld)){ System.out.println("PRUTH: reading userdata from file " + this.file);
     * ini = new Ini(new File(this.file)); } else { System.out.println("PRUTH: using userdata from userdataOld string");
    ...
    public void execute() throws BuildException {
        ...
        try {
            ...
            System.out.println("PRUTH: this.section = " + this.section + ", this.key = " + this.key + ", this.value = "
                    + this.value);
            ...
            try {
                ...
                while (line != null) {
                    ...
                    if (!processedKey && prev_section.equals(this.section)) {
                        System.out.println(
                                "Adding new key to " + prev_section + " section of userdata: " + this.key.trim());
