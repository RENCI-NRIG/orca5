...
public abstract class RestTask extends OrcaAntTask {
	...
	protected void doPost() throws BuildException {
		...
		try {
			...
			if (pr.getResId() != null) {
				System.out.println("---- PluginReturn: " + pr.toString());
				System.out.println("---- reservationIdProperty name = " + reservationIdProperty);
				System.out.println("---- reservation id is " + pr.getResId());
