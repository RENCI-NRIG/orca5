...
import orca.handlers.network.core.NetconfDevice;

public class IBMRouterDevice extends NetconfDevice implements
		IRouterDevice, RouterConstants {
	...
	@Override
	public void createVLAN(String vlanTag, String qosRate, String qosBurstSize)
		...
		try {
			if ((qosRate != null) && (qosRate.length() != 0) && (Long.parseLong(qosRate) > 0)) {
				if ((qosBurstSize == null) || (qosBurstSize.length() == 0) || (Long.parseLong(qosBurstSize) <= 0))
					throw new CommandException("Burst size " + qosBurstSize + " is null, negative or empty in createVLAN");
	...
	@Override
	public void deleteVLAN(String vlanTag, boolean withQoS)
			throws CommandException {
	...
	@Override
	public void addTrunkPortsToVLAN(String vlanTag, String ports)
			throws CommandException {
	...
	@Override
	public void addAccessPortsToVLAN(String vlanTag, String ports)
			throws CommandException {
		String commandBuffer = "";
	...
	@Override
	public void removeTrunkPortsFromVLAN(String vlanTag, String ports)
			throws CommandException {
		String commandBuffer = "";
	...
	@Override
	public void removeAccessPortsFromVLAN(String vlanTag, String ports)
			throws CommandException {
		String commandBuffer = "";
	...
	protected Integer findFreeVmap() throws CommandException {
		...
		try {
			...
			throw new CommandException("Unable to find free VMAP in device " + device.gethostName() + " due to IO error: " + ioe);
		}
	}
	...
	protected void genericUpdateCommand(String commandName, String commandBuffer) throws CommandException {
        ...
        if (!isEmulationEnabled()) {
            ...
            System.out.println(commandName + " command buffer: <rpc> <load-configuration action=\"merge\" format=\"text\"> <configuration-text> " + 
