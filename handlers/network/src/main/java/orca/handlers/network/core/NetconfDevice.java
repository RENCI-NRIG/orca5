...
public class NetconfDevice extends ConsoleDevice {
	...
	public void executeCommand(String cmd) throws CommandException {
		...
		try {
			...
			throw new CommandException("Unable to update configuration of netconf device " + deviceAddress + " due to: " + e);
		}
	}
	
	
	/**
	 * Perform variable substitutions in the script. Variable names and values are in the properties.
	 * Variables in the script should appear as {$VariableName}
	 * @param data
	 * @param props
	 * @return
	 * @throws CommandException
