...
import net.exogeni.orca.handlers.network.core.XMLRPCDevice;
...
public class FlowVisorDevice extends XMLRPCDevice implements OpenFlowConstants {
    ...
    public void addIPFlowSpace(String name, String dpid, String priority, String srcIP, String dstIP)
        ...
        try {
            ...
            Map<String, String> map_src_to_dst = FlowChange.makeMap(FlowChangeOp.ADD, dpid, null, priority, match,
                    actions);
            FlowChange.fromMap(map_src_to_dst);
            mapList.add(map_src_to_dst);

            match = "nw_src=" + dstIP + ",nw_dst=" + srcIP;
            Map<String, String> map_dst_to_src = FlowChange.makeMap(FlowChangeOp.ADD, dpid, null, priority, match,
                    actions);
    ...
    public void addVlanFlowSpace(String name, String dpid, String priority, int tag, String ports)
        ...
        if ((name == null) || (dpid == null) || (priority == null) || (ports == null))
            throw new CommandException(
                    "addVlanFlowSpace(): Slice name, dpid, priority and fvPort list must be specified ");
        ...
        try {
            if (ports.matches("any")) {
                ...
                Map<String, String> mapVlan = FlowChange.makeMap(FlowChangeOp.ADD, dpid, null, priority, match,
                        actions);
    ...
    public void connect() throws CommandException {
        ...
        try {
            ...
            // e.printStackTrace();
            logger.error("FlowVisorDevice: unable to connect to " + url + " user " + uid + " pass " + passwd
