...
import net.exogeni.orca.manage.beans.ReservationPredecessorMng;
...
public abstract class ReservationTest extends ManagementTest {
    ...
    public void testBrokerInventory() {
        ...
        for (ReservationMng r : rs) {
            System.out.println("\t(" + r.getReservationID() + ") type=" + r.getResourceType() + " start: "
                    + r.getStart() + " stop:" + r.getEnd() + " units=" + r.getUnits());
        }
    }
    ...
    public void testModifyResources() throws Exception {
        ...
        ArrayList<PropertyMng> listPmngConfig = (ArrayList<PropertyMng>) sm.getReservation(rid)
                .getConfigurationProperties().getProperty();
        ...
        ArrayList<PropertyMng> listPmng = (ArrayList<PropertyMng>) sm.getUnits(rid).get(0).getProperties()
                .getProperty();
        ...
        ArrayList<PropertyMng> listPmngConfigAM = (ArrayList<PropertyMng>) am.getReservation(rid)
                .getConfigurationProperties().getProperty();
        ...
        ArrayList<PropertyMng> listPmngAM = (ArrayList<PropertyMng>) am.getUnits(rid).get(0).getProperties()
                .getProperty();
