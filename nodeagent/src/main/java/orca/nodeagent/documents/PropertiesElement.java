...
public class PropertiesElement implements org.apache.axis2.databinding.ADBBean {
     ...
     * http://orca/nodeagent/documents Namespace Prefix = ns1
     */
    ...
    protected orca.nodeagent.documents.PropertyElement[] localProperty;
     ...
     * 
     * @return orca.nodeagent.documents.PropertyElement[]
     */
    public orca.nodeagent.documents.PropertyElement[] getProperty() {
     ...
     */
    protected void validateProperty(orca.nodeagent.documents.PropertyElement[] param) {
     ...
     *            Property
     */
    public void setProperty(orca.nodeagent.documents.PropertyElement[] param) {
     ...
     * 
     * @param param
     *            orca.nodeagent.documents.PropertyElement
     */
    public void addProperty(orca.nodeagent.documents.PropertyElement param) {
        if (localProperty == null) {
            localProperty = new orca.nodeagent.documents.PropertyElement[] {};
        }
        ...
        list.add(param);
        this.localProperty = (orca.nodeagent.documents.PropertyElement[]) list
                .toArray(new orca.nodeagent.documents.PropertyElement[list.size()]);
        ...
        public static PropertiesElement parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"propertiesElement".equals(type)) {
                            ...
                            return (PropertiesElement) orca.nodeagent.documents.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("", "property").equals(reader.getName())) {
                    ...
                    list1.add(orca.nodeagent.documents.PropertyElement.Factory.parse(reader));
                    ...
                    object.setProperty(
                            (orca.nodeagent.documents.PropertyElement[]) org.apache.axis2.databinding.utils.ConverterUtil
                                    .convertToArray(orca.nodeagent.documents.PropertyElement.class, list1));
