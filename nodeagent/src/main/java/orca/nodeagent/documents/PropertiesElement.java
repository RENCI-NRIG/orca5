        ...
        /* This type was generated from the piece of schema that had
                ...
                Namespace URI = http://orca/nodeagent/documents
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  orca.nodeagent.documents.PropertyElement[] getProperty(){
                             ...
                             * @param param orca.nodeagent.documents.PropertyElement
                             */
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localProperty);
                               list.add(param);
                               this.localProperty =
                             (orca.nodeagent.documents.PropertyElement[])list.toArray(
                            new orca.nodeagent.documents.PropertyElement[list.size()]);
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"propertiesElement".equals(type)){
                        ...
                        return (PropertiesElement)orca.nodeagent.documents.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(orca.nodeagent.documents.PropertyElement.Factory.parse(reader));
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setProperty((orca.nodeagent.documents.PropertyElement[])
                                                        org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                            orca.nodeagent.documents.PropertyElement.class,
                                                            list1));
