...
public class ExtensionMapper {
    ...
    public static java.lang.Object getTypeObject(java.lang.String namespaceURI, java.lang.String typeName,
        ...
        if ("http://orca/nodeagent/documents".equals(namespaceURI) && "propertiesElement".equals(typeName)) {

            return orca.nodeagent.documents.PropertiesElement.Factory.parse(reader);

        }

        if ("http://orca/nodeagent/documents".equals(namespaceURI) && "propertyElement".equals(typeName)) {
