        ...
        public  class RegisterAuthorityKeyElement
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://orca/nodeagent/documents",
                "registerAuthorityKeyElement",
                "ns1");
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
                    ...
                    xmlWriter.writeStartElement(parentQName.getLocalPart());
                             ...
                             if (localRequest!=null) {
                                   ...
                                   for (int i = 0;i < localRequest.length;i++){
                                            ...
                                            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRequest[i]));
                                            xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static RegisterAuthorityKeyElement parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"registerAuthorityKeyElement".equals(type)){
                        ...
                        return (RegisterAuthorityKeyElement)orca.nodeagent.documents.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","alias").equals(reader.getName())){
