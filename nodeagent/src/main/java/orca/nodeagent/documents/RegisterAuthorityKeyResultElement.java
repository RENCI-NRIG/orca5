        ...
        public  class RegisterAuthorityKeyResultElement
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
                    ...
                    xmlWriter.writeStartElement(parentQName.getLocalPart());
                             ...
                             if (localResponse!=null) {
                                   ...
                                   for (int i = 0;i < localResponse.length;i++){
                                            ...
                                            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localResponse[i]));
                                            xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static RegisterAuthorityKeyResultElement parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"registerAuthorityKeyResultElement".equals(type)){
                        ...
                        return (RegisterAuthorityKeyResultElement)orca.nodeagent.documents.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
