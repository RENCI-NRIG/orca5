    ...
    public NodeAgentServiceStub(java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
        ...
        _operationClient.addMessageContext(_messageContext);
                    ...
                    public void onComplete(
                        ...
                        callback.receiveResultregisterAuthorityKey((orca.nodeagent.documents.RegisterAuthorityKeyResultElement) object);
                    }
     ...
     //http://localhost:8080/shirako/services/NodeAgentService
            ...
            private  org.apache.axiom.om.OMElement  toOM(orca.nodeagent.documents.RegisterKeyResultElement param, boolean optimizeContent){
                     ...
                     return param.getOMElement(orca.nodeagent.documents.RegisterKeyResultElement.MY_QNAME,
                        ...
                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, orca.nodeagent.documents.DriverElement param, boolean optimizeContent){
                        ...
                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, orca.nodeagent.documents.ScriptElement param, boolean optimizeContent){
                        org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                        ...
                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, orca.nodeagent.documents.TestFuncElement param, boolean optimizeContent){
                        org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                             
                                    emptyEnvelope.getBody().addChild(param.getOMElement(orca.nodeagent.documents.TestFuncElement.MY_QNAME,factory));
                        ...
                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, orca.nodeagent.documents.DriverObjectRequestElement param, boolean optimizeContent){
                        org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                             
                                    emptyEnvelope.getBody().addChild(param.getOMElement(orca.nodeagent.documents.DriverObjectRequestElement.MY_QNAME,factory));
                        ...
                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, orca.nodeagent.documents.UnregisterKeyElement param, boolean optimizeContent){
                        org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                             
                                    emptyEnvelope.getBody().addChild(param.getOMElement(orca.nodeagent.documents.UnregisterKeyElement.MY_QNAME,factory));
                        ...
                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, orca.nodeagent.documents.DriverRequestElement param, boolean optimizeContent){
                        org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                             
                                    emptyEnvelope.getBody().addChild(param.getOMElement(orca.nodeagent.documents.DriverRequestElement.MY_QNAME,factory));
                        ...
                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, orca.nodeagent.documents.RegisterAuthorityKeyElement param, boolean optimizeContent){
                        org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                             
                                    emptyEnvelope.getBody().addChild(param.getOMElement(orca.nodeagent.documents.RegisterAuthorityKeyElement.MY_QNAME,factory));
                        ...
                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, orca.nodeagent.documents.GetServiceKeyElement param, boolean optimizeContent){
                        org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                             
                                    emptyEnvelope.getBody().addChild(param.getOMElement(orca.nodeagent.documents.GetServiceKeyElement.MY_QNAME,factory));
                        ...
                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, orca.nodeagent.documents.RegisterKeyElement param, boolean optimizeContent){
                        org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                             
                                    emptyEnvelope.getBody().addChild(param.getOMElement(orca.nodeagent.documents.RegisterKeyElement.MY_QNAME,factory));
