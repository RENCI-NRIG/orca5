...
/**
* DriverObjectRequestElement.java
*
...
/**
 * DriverObjectRequestElement bean class
 */

public class DriverObjectRequestElement implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://net.exogeni.orca/nodeagent/documents", "driverObjectRequestElement", "ns1");
    ...
    protected net.exogeni.orca.nodeagent.documents.PropertiesElement localProperties;
     ...
     * Auto generated getter method
     * 
     * @return net.exogeni.orca.nodeagent.documents.PropertiesElement
     */
    public net.exogeni.orca.nodeagent.documents.PropertiesElement getProperties() {
     ...
     *            Properties
     */
    public void setProperties(net.exogeni.orca.nodeagent.documents.PropertiesElement param) {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) {
        ...
        elementList.add(new javax.xml.namespace.QName("", "objectId"));
    ...
    public static class Factory {
       ...
       * @param reader reader
       * @return DriverObjectRequestElement 
       * @throws java.lang.Exception in case of error
         */
        public static DriverObjectRequestElement parse(javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            DriverObjectRequestElement object = new DriverObjectRequestElement();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"driverObjectRequestElement".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DriverObjectRequestElement) net.exogeni.orca.nodeagent.documents.ExtensionMapper
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName("", "objectId").equals(reader.getName())) {
                        ...
                        if (reader.isStartElement()
                            ...
                            object.setProperties(net.exogeni.orca.nodeagent.documents.PropertiesElement.Factory.parse(reader));
