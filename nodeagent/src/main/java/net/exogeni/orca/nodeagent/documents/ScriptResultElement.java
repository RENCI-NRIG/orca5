...
public class ScriptResultElement implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://net.exogeni.orca/nodeagent/documents", "scriptResultElement", "ns1");
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) {
        ...
        if (localStdOutTracker) {
            elementList.add(new javax.xml.namespace.QName("", "stdOut"));
        ...
        if (localStdErrorTracker) {
            elementList.add(new javax.xml.namespace.QName("", "stdError"));
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"scriptResultElement".equals(type)) {
                            ...
                            return (ScriptResultElement) net.exogeni.orca.nodeagent.documents.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName("", "stdOut").equals(reader.getName())) {

                            java.lang.String content = reader.getElementText();

                            object.setStdOut(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName("", "stdError").equals(reader.getName())) {
