...
/**
 * GetServiceKeyElement bean class
 */

public class GetServiceKeyElement implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://net.exogeni.orca/nodeagent/documents", "getServiceKeyElement", "ns1");
    ...
    public static class Factory {
       ...
       * @param reader reader
       * @return GetServiceKeyElement 
       * @throws java.lang.Exception in case of error
         */
        public static GetServiceKeyElement parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetServiceKeyElement object = new GetServiceKeyElement();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getServiceKeyElement".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetServiceKeyElement) net.exogeni.orca.nodeagent.documents.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
