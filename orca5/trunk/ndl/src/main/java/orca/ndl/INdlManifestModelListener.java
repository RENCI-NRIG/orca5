...
public interface INdlManifestModelListener extends INdlCommonModelListener {
	 ...
	 * @param m
	 * @param interfaces
	 * @param parent NetworkConnection (if any)
	 */
	...
	/**
	 * Return the proper sequence of resources (nodes, linkconnections, crossconnects etc) for a NetworkConnection. Never repeated.
	 * @param c
	 * @param m
	 * @param path - list of paths (for multipoint connections). 
	 * @param roots - list of multicast roots (if any - can be null)
	 */
