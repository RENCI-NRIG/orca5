...
/**
 * Class made for printing scaled values of integers. Example: you can 
 * print value of bandwidth=10000000 as System.out.println(new ScaledFormatPrinter(bandwidth, "bps"))
 * and you will see 10Mbps as the result.
 * 
...
public class ScaledFormatPrinter {
	...
	/**
	 * Create an instance of a ScaledFormatPrinter. Type is any string containing measurement units
	 * e.g. "hz" or "s" or "bps". Example: you can print value of bandwidth=10000000 as 
	 * System.out.println(new ScaledFormatPrinter(bandwidth, "bps"))
	 * and you will see 
	 * 10Mbps 
	 * as the result.
	 * @param value
