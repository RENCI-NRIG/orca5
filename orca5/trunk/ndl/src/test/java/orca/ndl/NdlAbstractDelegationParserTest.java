...
public class NdlAbstractDelegationParserTest implements
INdlAbstractDelegationModelListener {

	public void ndlNetworkDomain(Resource dom, OntModel m, List<Resource> netService,
			List<Resource> interfaces, List<LabelSet> labelSets, Map<Resource, 
			List<LabelSet>> netLabelSets) {
