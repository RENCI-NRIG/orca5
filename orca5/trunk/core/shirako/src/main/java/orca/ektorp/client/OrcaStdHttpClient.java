...
/**
 * HttpClient for interacting with CouchdB extended to support multikeymanager and trustedmanager (SSL mode).
 * @author Claris Castillo
 * 
 */
@SuppressWarnings("deprecation")
public class OrcaStdHttpClient implements HttpClient {
	private static byte[] registryCertDigest = new byte[16];
	private final org.apache.http.client.HttpClient client;
	private final org.apache.http.client.HttpClient backend;
	private final static String registryCertFingerprint = "df:5c:1d:99:46:9a:5f:a8:92:8e:15:e4:b9:82:d8:ad";
	protected static boolean sslError=false;
	private final static Logger LOG = LoggerFactory
			.getLogger(OrcaStdHttpClient.class);

	public OrcaStdHttpClient(org.apache.http.client.HttpClient hc) {
		this(hc, hc);
	}
	public OrcaStdHttpClient(org.apache.http.client.HttpClient hc, 
	...
	public static class Builder {
		...
		protected Scheme configureScheme() {
			if (enableSSL) {//SecureProtocolSocketFactory
				...
				try {
					...
					if (sslSocketFactory == null) {
						...
						if (relaxedSSLSettings) {
							context.init(new MultiKeyManager[] {mkm},new TrustManager[] {tm}, null);
						} else {
		...
		public Builder keyManager(MultiKeyManager multikeymanager) {
			this.mkm = multikeymanager;
			return this;
		}
		
		public Builder trustManager(TrustManager trustManager) {
		...
		public HttpClient build() {
			...
			return new OrcaStdHttpClient(cachingHttpClient, client);
		}
