...
_serviceClient.getOptions().setTimeOutInMilliSeconds(1000000000);
    ...
    public ServiceManagerServiceStub(java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
        this(null,targetEndpoint);
                    ...
                    * @see orca.shirako.proxies.soapaxis2.services.ServiceManagerService#updateLease
                        * @param param100
...
orca.shirako.proxies.soapaxis2.util.ContextTools.setMyAuthToken(_messageContext, authToken);        // add the message contxt to the operation client
        ...
        _operationClient.execute(true);
            ...
            if (faultElt!=null){
                ...
                * @see orca.shirako.proxies.soapaxis2.services.ServiceManagerService#startupdateLease
                    * @param param100
                
                */
                public  void startupdateLease(
                 orca.shirako.proxies.soapaxis2.services.UpdateLease param100,
                  final orca.shirako.proxies.soapaxis2.services.ServiceManagerServiceCallbackHandler callback, orca.security.AuthToken authToken) throws java.rmi.RemoteException{
              org.apache.axis2.client.OperationClient _operationClient = _serviceClient.createClient(_operations[0].getName());
             _operationClient.getOptions().setAction("updateLease");
             _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        ...
        if ( _operations[0].getMessageReceiver()==null &&  _operationClient.getOptions().isUseSeparateListener()) {
          ...
          _operations[0].setMessageReceiver(
           ...
           _operationClient.execute(false);
                    ...
                    /**
                    * Auto generated method signature
                    * @see orca.shirako.proxies.soapaxis2.services.ServiceManagerService#updateTicket
                        * @param param102
...
orca.shirako.proxies.soapaxis2.util.ContextTools.setMyAuthToken(_messageContext, authToken);        // add the message contxt to the operation client
        ...
        _operationClient.execute(true);
            ...
            if (faultElt!=null){
                ...
                /**
                * Auto generated method signature for Asynchronous Invocations
                * @see orca.shirako.proxies.soapaxis2.services.ServiceManagerService#startupdateTicket
                    * @param param102
        ...
        if ( _operations[1].getMessageReceiver()==null &&  _operationClient.getOptions().isUseSeparateListener()) {
          ...
          _operations[1].setMessageReceiver(
           ...
           _operationClient.execute(false);
                    ...
                    /**
                    * Auto generated method signature
                    * @see orca.shirako.proxies.soapaxis2.services.ServiceManagerService#query
                        * @param param104
...
orca.shirako.proxies.soapaxis2.util.ContextTools.setMyAuthToken(_messageContext, authToken);        // add the message contxt to the operation client
        ...
        _operationClient.execute(true);
            ...
            if (faultElt!=null){
                ...
                /**
                * Auto generated method signature for Asynchronous Invocations
                * @see orca.shirako.proxies.soapaxis2.services.ServiceManagerService#startquery
                    * @param param104
        ...
        if ( _operations[2].getMessageReceiver()==null &&  _operationClient.getOptions().isUseSeparateListener()) {
          ...
          _operations[2].setMessageReceiver(
           ...
           _operationClient.execute(false);
                    ...
                    /**
                    * Auto generated method signature
                    * @see orca.shirako.proxies.soapaxis2.services.ServiceManagerService#failedRPC
                        * @param param106
...
orca.shirako.proxies.soapaxis2.util.ContextTools.setMyAuthToken(_messageContext, authToken);        // add the message contxt to the operation client
        ...
        _operationClient.execute(true);
            ...
            if (faultElt!=null){
                ...
                /**
                * Auto generated method signature for Asynchronous Invocations
                * @see orca.shirako.proxies.soapaxis2.services.ServiceManagerService#startfailedRPC
                    * @param param106
        ...
        if ( _operations[3].getMessageReceiver()==null &&  _operationClient.getOptions().isUseSeparateListener()) {
          ...
          _operations[3].setMessageReceiver(
           ...
           _operationClient.execute(false);
                    ...
                    /**
                    * Auto generated method signature
                    * @see orca.shirako.proxies.soapaxis2.services.ServiceManagerService#queryResult
                        * @param param108
...
orca.shirako.proxies.soapaxis2.util.ContextTools.setMyAuthToken(_messageContext, authToken);        // add the message contxt to the operation client
        ...
        _operationClient.execute(true);
            ...
            if (faultElt!=null){
                ...
                /**
                * Auto generated method signature for Asynchronous Invocations
                * @see orca.shirako.proxies.soapaxis2.services.ServiceManagerService#startqueryResult
                    * @param param108
