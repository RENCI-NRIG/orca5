 ...
 * @author grit
 */
public class AgentQueuedBestFitPolicyPlugin extends BrokerBestFitPolicyPlugin
{
    /**
     * Queue of requests that failed but have been deferred: not sure how to
     * recover queue
     */
    protected Vector<BrokerReservation> queue;

    public AgentQueuedBestFitPolicyPlugin()
    {
        super();
        queue = new Vector<BrokerReservation>();
    }
