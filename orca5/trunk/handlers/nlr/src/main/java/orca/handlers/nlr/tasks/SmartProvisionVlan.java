...
/**
 * If vlan id is given, check available reservations, if available,
 * then provision it, otherwise fail.
 * If vlan id is not given, check available reservations, if available
 * pick one and provision. If not available, reserve a new one, then
 * provision.
 * @author ibaldin
 *
 */
