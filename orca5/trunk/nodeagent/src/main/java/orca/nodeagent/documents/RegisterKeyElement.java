        ...
        public  class RegisterKeyElement
                    ...
                    xmlWriter.writeStartElement(parentQName.getLocalPart());
                             ...
                             if (localPublickey!=null) {
                                   ...
                                   for (int i = 0;i < localPublickey.length;i++){
                                            ...
                                            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPublickey[i]));
                                            xmlWriter.writeEndElement();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"registerKeyElement".equals(type)){
                        ...
                        return (RegisterKeyElement)orca.nodeagent.documents.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
