...
import net.exogeni.orca.shirako.common.RPCException;
import net.exogeni.orca.shirako.common.ReservationState;
import net.exogeni.orca.shirako.common.ResourceType;
import net.exogeni.orca.shirako.container.ConfigurationException;
...
import net.exogeni.orca.shirako.meta.ConfigurationProperties;
import net.exogeni.orca.shirako.meta.QueryProperties;
import net.exogeni.orca.shirako.meta.ResourcePoolAttributeDescriptor;
import net.exogeni.orca.shirako.meta.ResourcePoolDescriptor;
import net.exogeni.orca.shirako.meta.ResourcePoolsDescriptor;
import net.exogeni.orca.shirako.meta.ResourceProperties;
