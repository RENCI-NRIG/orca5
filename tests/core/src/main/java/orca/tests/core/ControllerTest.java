...
public class ControllerTest extends ShirakoTest
{
    ...
    protected void startController(String actorName, PackageId packageId, PluginId controllerId, Properties cp) throws Exception
    {
        ...
        try {
            ...
            throw new RuntimeException("An error occurred while creating controller. Error code=" + e.getErrorCode(), e);
        }        
    }    
}
