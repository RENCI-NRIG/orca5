...
public class CloudHandlerTest {
    ...
    public void testRunEmbedding() throws Exception {
        ...
        // err = cloudHandler.runEmbedding("http://geni-orca.renci.org/owl/mass.rdf#mass/Domain", request,
        // domainResourcePools);
        err = cloudHandler.runEmbedding("http://geni-orca.renci.org/owl/rcivmsite.rdf#rcivmsite/Domain", request,
                domainResourcePools);
        ...
        // System.out.println("domainConnectionList: " +
        // Arrays.toString(cloudHandler.domainConnectionList.entrySet().toArray()));
        ...
        for (NetworkElement element : deviceList) {
            ...
            if (defaultClientInterface != null) {
                ...
                if (resource != null) {
                    ...
                    OntResource addressProperty = (OntResource) resource
                            .getPropertyValue(NdlCommons.ip4LocalIPAddressProperty);
                    ...
                    if (addressLabelProperty != null) {
                        assertFalse("IPAddress property should not contain CIDR",
                                addressLabelProperty.toString().contains("/"));
                    }
                }
            }
        }
