...
package net.exogeni.orca.extensions.internal;
...
import net.exogeni.orca.extensions.internal.db.IPackageDatabase;
import net.exogeni.orca.shirako.container.ContainerConstants;
import net.exogeni.orca.shirako.container.Globals;
import net.exogeni.orca.util.ChangeClasspath;
import net.exogeni.orca.util.ExecutionResult;
import net.exogeni.orca.util.ScriptExecutor;
...
public class PackageManager {
     ...
     */
    protected Properties fill(net.exogeni.orca.extensions.beans.Properties mng) {
        Properties p = null;

        if (mng != null) {
            List<net.exogeni.orca.extensions.beans.Property> props = mng.getProperty();

            if (props != null) {
                p = new Properties();

                for (net.exogeni.orca.extensions.beans.Property property : props) {
     ...
     */
    protected ExtensionPackage getPackage(net.exogeni.orca.extensions.beans.ExtensionPackage pkg) {
     ...
     */
    protected Plugin getPlugin(ExtensionPackage pkg, net.exogeni.orca.extensions.beans.Plugin p) {
    ...
    public int installPackage(byte[] bytes, boolean failIfExists) {
        ...
        try {
            ...
            if (folder == null) {
            	...
            	net.exogeni.orca.extensions.beans.ExtensionPackage desc = readPackageDescriptor(folder);
     ...
     * @throws Exception in case of error
     */
    protected net.exogeni.orca.extensions.beans.ExtensionPackage readPackageDescriptor(String folder) throws Exception {
        String file = folder + "/" + PackageDescriptorFile;
        InputStream is = new FileInputStream(file);
        JAXBContext context = JAXBContext.newInstance("net.exogeni.orca.extensions.beans");
        Unmarshaller um = context.createUnmarshaller();

        return (net.exogeni.orca.extensions.beans.ExtensionPackage) um.unmarshal(is);
    }
     ...
     * @throws Exception in case of error
     */
    protected void registerPackage(net.exogeni.orca.extensions.beans.ExtensionPackage pkg) throws Exception {
        /*
         ...
         */
        net.exogeni.orca.extensions.beans.Plugins plugins = pkg.getPlugins();
        List<net.exogeni.orca.extensions.beans.Plugin> list = plugins.getPlugin();

        if (list != null) {
            for (net.exogeni.orca.extensions.beans.Plugin p : list) {
