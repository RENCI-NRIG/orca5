...
/**
 *  ExtendTicketResponse bean class
 */
        
public  class ExtendTicketResponse
    implements org.apache.axis2.databinding.ADBBean{

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://orca/shirako/proxies/soapaxis2/services",
            "extendTicketResponse",
            "ns2");
    ...
    public static class Factory{
         ...
         * @param reader reader
         * @return ExtendTicketResponse 
         * @throws java.lang.Exception in case of error
         */
        public static ExtendTicketResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ExtendTicketResponse object = new ExtendTicketResponse();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                    ...
                    if (fullTypeName!=null){
                        ...
                        if (!"extendTicketResponse".equals(type)){
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ExtendTicketResponse)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                    nsUri,type,reader);
                        }
