...
public  class TicketResponse
    ...
    public static class Factory{
        ...
        public static TicketResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TicketResponse object = new TicketResponse();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                    ...
                    if (fullTypeName!=null){
                        ...
                        if (!"ticketResponse".equals(type)){
                            ...
                            return (TicketResponse)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                    nsUri,type,reader);
                        }
