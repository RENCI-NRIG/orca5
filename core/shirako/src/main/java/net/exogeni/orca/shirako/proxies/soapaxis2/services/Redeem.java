...
public  class Redeem
    ...
    public static class Factory{
         ...
         */
        public static Redeem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Redeem object = new Redeem();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                    ...
                    if (fullTypeName!=null){
                        ...
                        if (!"redeem".equals(type)){
                            ...
                            return (Redeem)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                    nsUri,type,reader);
                        }
