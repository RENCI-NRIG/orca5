...
public class AuthorityServiceSkeleton extends BrokerServiceSkeleton {
     ...
     */
    protected IAuthorityReservation passAuthority(net.exogeni.orca.shirako.proxies.soapaxis2.beans.Reservation beanReservation) throws Exception {
        // translate all beans to slices objects
        ISlice s = Translate.translate(beanReservation.getSlice());
        net.exogeni.orca.shirako.time.Term term = Translate.translate(beanReservation.getTerm());
        net.exogeni.orca.shirako.kernel.ResourceSet rset = Translate.translate(beanReservation.getResourceSet());
    ...
    public net.exogeni.orca.shirako.proxies.soapaxis2.services.CloseResponse close(net.exogeni.orca.shirako.proxies.soapaxis2.services.Close request) throws RemoteException {
    ...
    public net.exogeni.orca.shirako.proxies.soapaxis2.services.RedeemResponse redeem(net.exogeni.orca.shirako.proxies.soapaxis2.services.Redeem request) throws RemoteException {
    ...
    public net.exogeni.orca.shirako.proxies.soapaxis2.services.ExtendLeaseResponse extendLease(net.exogeni.orca.shirako.proxies.soapaxis2.services.ExtendLease request) throws RemoteException {
        AuthToken authToken = doAuthorize();
        IncomingRPC rpc;
        try {
            // recreate the reservation
    ...
    public net.exogeni.orca.shirako.proxies.soapaxis2.services.ModifyLeaseResponse modifyLease(net.exogeni.orca.shirako.proxies.soapaxis2.services.ModifyLease request) throws RemoteException {
        AuthToken authToken = doAuthorize();
        IncomingRPC rpc;
        try {
            // recreate the reservation
