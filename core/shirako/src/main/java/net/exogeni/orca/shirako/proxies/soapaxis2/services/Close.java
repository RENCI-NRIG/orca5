...
public  class Close
    ...
    public static class Factory{
         ...
         */
        public static Close parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Close object = new Close();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                    ...
                    if (fullTypeName!=null){
                        ...
                        if (!"close".equals(type)){
                            ...
                            return (Close)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                    nsUri,type,reader);
                        }
