        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        protected net.exogeni.orca.shirako.proxies.soapaxis2.beans.Plist localPvalue ;
                        
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPvalueTracker = false ;
                           

                           /**
                           * Auto generated getter method
                           * @return net.exogeni.orca.shirako.proxies.soapaxis2.beans.Plist
                           */
                           public  net.exogeni.orca.shirako.proxies.soapaxis2.beans.Plist getPvalue(){
                               return localPvalue;
                           }
                            ...
                            /**
                               ...
                               * @param param Pvalue
                               */
                               public void setPvalue(net.exogeni.orca.shirako.proxies.soapaxis2.beans.Plist param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localPvalueTracker = true;
                                       } else {
                                          localPvalueTracker = false;
                                              
                                       }
                                   
                                    this.localPvalue=param;
         ...
         public void serialize(
                ...
                if (namespace != null) {
                    ...
                    xmlWriter.writeStartElement(parentQName.getLocalPart());
                              ...
                              if (localPvalueTracker){
                                    if (localPvalue==null){
                                         throw new RuntimeException("pvalue cannot be null!!");
                                    }
                                   localPvalue.getOMDataSource(
                                       new javax.xml.namespace.QName("","pvalue"),
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"plistNode".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (PlistNode)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","pvalue").equals(reader.getName())){
                                
                                        object.setPvalue(net.exogeni.orca.shirako.proxies.soapaxis2.beans.Plist.Factory.parse(reader));
