...
public  class Relinquish
    ...
    public static class Factory{
         ...
         */
        public static Relinquish parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Relinquish object = new Relinquish();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                    ...
                    if (fullTypeName!=null){
                        ...
                        if (!"relinquish".equals(type)){
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (Relinquish)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                    nsUri,type,reader);
                        }
