...
import net.exogeni.orca.shirako.proxies.soapaxis2.services.UpdateLease;
import net.exogeni.orca.shirako.proxies.soapaxis2.services.UpdateTicket;
...
public class SoapAxis2Return extends SoapAxis2Proxy implements IServiceManagerCallbackProxy {
    ...
    private net.exogeni.orca.shirako.proxies.soapaxis2.beans.Reservation passReservation(IServerReservation r, AuthToken auth) {
        net.exogeni.orca.shirako.proxies.soapaxis2.beans.Reservation res = new net.exogeni.orca.shirako.proxies.soapaxis2.beans.Reservation();
        ...
        net.exogeni.orca.shirako.proxies.soapaxis2.beans.ResourceSet rset = null;

        if (r.getResources() == null) {
            rset = Translate.translate(new net.exogeni.orca.shirako.kernel.ResourceSet(0, r.getRequestedType()), Translate.DirectionReturn);
        } else {
