...
/**
 *  ExtendLease bean class
 */
        
public  class ExtendLease
    ...
    public static class Factory{
         ...
         */
        public static ExtendLease parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ExtendLease object = new ExtendLease();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                    ...
                    if (fullTypeName!=null){
                        ...
                        if (!"extendLease".equals(type)){
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ExtendLease)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                    nsUri,type,reader);
                        }
