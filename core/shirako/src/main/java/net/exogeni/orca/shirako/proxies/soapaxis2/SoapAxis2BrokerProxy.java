...
import net.exogeni.orca.shirako.proxies.soapaxis2.services.Claim;
import net.exogeni.orca.shirako.proxies.soapaxis2.services.ExtendTicket;
import net.exogeni.orca.shirako.proxies.soapaxis2.services.Relinquish;
import net.exogeni.orca.shirako.proxies.soapaxis2.services.Ticket;
...
public class SoapAxis2BrokerProxy extends SoapAxis2Proxy implements IBrokerProxy {
     ...
     */
    protected net.exogeni.orca.shirako.proxies.soapaxis2.beans.Reservation passBrokerReservation(IReservation reservation, AuthToken auth) {
        ...
        net.exogeni.orca.shirako.proxies.soapaxis2.beans.ResourceSet rset = Translate.translate(r.getRequestedResources(), Translate.DirectionAgent);
