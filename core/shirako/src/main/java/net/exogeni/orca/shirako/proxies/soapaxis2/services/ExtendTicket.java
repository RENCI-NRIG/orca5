...
public  class ExtendTicket
    ...
    public static class Factory{
         ...
         */
        public static ExtendTicket parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ExtendTicket object = new ExtendTicket();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                    ...
                    if (fullTypeName!=null){
                        ...
                        if (!"extendTicket".equals(type)){
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ExtendTicket)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                    nsUri,type,reader);
                        }
