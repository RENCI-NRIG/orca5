        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        protected net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode[] localPlistNode ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode[]
                           */
                           public  net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode[] getPlistNode(){
                               ...
                               * @param param param
                               */
                              protected void validatePlistNode(net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode[] param){
                              ...
                              */
                              public void setPlistNode(net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode[] param){
                             ...
                             * @param param net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode
                             */
                             public void addPlistNode(net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode param){
                                   if (localPlistNode == null){
                                   localPlistNode = new net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPlistNode);
                               list.add(param);
                               this.localPlistNode =
                             (net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode[])list.toArray(
                            new net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode[list.size()]);
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"plist".equals(type)){
                        ...
                        return (Plist)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode.Factory.parse(reader));
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setPlistNode((net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode[])
                                                        org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                            net.exogeni.orca.shirako.proxies.soapaxis2.beans.PlistNode.class,
                                                            list1));
