...
/**
 *  RelinquishResponse bean class
 */
        
public  class RelinquishResponse
    ...
    public static class Factory{
         ...
         * @param reader reader
         * @return RelinquishResponse 
         * @throws java.lang.Exception in case of error
         */
        public static RelinquishResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RelinquishResponse object = new RelinquishResponse();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                    ...
                    if (fullTypeName!=null){
                        ...
                        if (!"relinquishResponse".equals(type)){
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RelinquishResponse)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                    nsUri,type,reader);
                        }
