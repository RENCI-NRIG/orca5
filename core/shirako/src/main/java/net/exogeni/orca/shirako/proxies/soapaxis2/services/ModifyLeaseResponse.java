...
/**
 *  ModifyLeaseResponse bean class
 */
        
public  class ModifyLeaseResponse
    ...
    public static class Factory{
       ...
       * @throws java.lang.Exception in case of error
         */
        public static ModifyLeaseResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ModifyLeaseResponse object = new ModifyLeaseResponse();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                    ...
                    if (fullTypeName!=null){
                        ...
                        if (!"modifyLeaseResponse".equals(type)){
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ModifyLeaseResponse)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                    nsUri,type,reader);
                        }
