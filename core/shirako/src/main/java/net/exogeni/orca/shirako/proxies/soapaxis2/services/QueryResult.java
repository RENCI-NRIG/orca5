...
public  class QueryResult
    ...
    protected net.exogeni.orca.shirako.proxies.soapaxis2.beans.Properties localProperties ;
     ...
     */
    public  net.exogeni.orca.shirako.proxies.soapaxis2.beans.Properties getProperties(){
     ...
     */
    public void setProperties(net.exogeni.orca.shirako.proxies.soapaxis2.beans.Properties param){
        ...
        public static QueryResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                    ...
                    if (fullTypeName!=null){
                        ...
                        if (!"queryResult".equals(type)){
                            ...
                            return (QueryResult)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                    nsUri,type,reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("","properties").equals(reader.getName())){
                    ...
                    object.setProperties(net.exogeni.orca.shirako.proxies.soapaxis2.beans.Properties.Factory.parse(reader));
