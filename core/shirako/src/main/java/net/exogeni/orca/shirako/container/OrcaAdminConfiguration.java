...
public class OrcaAdminConfiguration implements IOrcaAdminConfiguration {
     ...
     */
    protected String configurationLoaderClass = "net.exogeni.orca.boot.ConfigurationLoader";
    ...
    private void loadDefaults() {
    	...
    	defaultProperties.setProperty(AdminConfigurationLoader, "net.exogeni.orca.boot.ConfigurationLoader");
