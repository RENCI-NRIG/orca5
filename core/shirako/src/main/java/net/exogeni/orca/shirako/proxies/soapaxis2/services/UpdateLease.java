...
/**
 *  UpdateLease bean class
 */
        
public  class UpdateLease
    ...
    protected net.exogeni.orca.shirako.proxies.soapaxis2.beans.Reservation localReservation ;


    /**
     * Auto generated getter method
     * @return net.exogeni.orca.shirako.proxies.soapaxis2.beans.Reservation
     */
    public  net.exogeni.orca.shirako.proxies.soapaxis2.beans.Reservation getReservation(){
     ...
     */
    public void setReservation(net.exogeni.orca.shirako.proxies.soapaxis2.beans.Reservation param){
    ...
    /**
     * field for UpdateData
     */

    protected net.exogeni.orca.shirako.proxies.soapaxis2.beans.UpdateData localUpdateData ;


    /**
     * Auto generated getter method
     * @return net.exogeni.orca.shirako.proxies.soapaxis2.beans.UpdateData
     */
    public  net.exogeni.orca.shirako.proxies.soapaxis2.beans.UpdateData getUpdateData(){
    ...
    /**
     * Auto generated setter method
     * @param param UpdateData
     */
    public void setUpdateData(net.exogeni.orca.shirako.proxies.soapaxis2.beans.UpdateData param){

        this.localUpdateData=param;
            ...
            new org.apache.axis2.databinding.ADBDataSource(this,parentQName){
                ...
                public void serialize(
                    ...
                    if (localUpdateData==null){
                        throw new RuntimeException("updateData cannot be null!!");
                    }
                    localUpdateData.getOMDataSource(
                            new javax.xml.namespace.QName("","updateData"),
                            factory).serialize(xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName){
        ...
        elementList.add(localUpdateData);
    ...
    public static class Factory{
         ...
         */
        public static UpdateLease parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpdateLease object = new UpdateLease();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                    ...
                    if (fullTypeName!=null){
                        ...
                        if (!"updateLease".equals(type)){
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (UpdateLease)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                    nsUri,type,reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("","reservation").equals(reader.getName())){
                    ...
                    object.setReservation(net.exogeni.orca.shirako.proxies.soapaxis2.beans.Reservation.Factory.parse(reader));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("","updateData").equals(reader.getName())){

                    object.setUpdateData(net.exogeni.orca.shirako.proxies.soapaxis2.beans.UpdateData.Factory.parse(reader));
