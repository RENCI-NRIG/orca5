...
import net.exogeni.orca.manage.internal.api.IActorManagementObject;
import net.exogeni.orca.manage.internal.api.IManagementObject;
import net.exogeni.orca.manage.internal.soap.SoapActorService;
import net.exogeni.orca.manage.internal.soap.SoapAuthorityService;
import net.exogeni.orca.manage.internal.soap.SoapBrokerService;
import net.exogeni.orca.manage.internal.soap.SoapClientActorService;
import net.exogeni.orca.manage.internal.soap.SoapContainerService;
import net.exogeni.orca.manage.internal.soap.SoapServerActorService;
import net.exogeni.orca.manage.internal.soap.SoapServiceManagerService;
...
import net.exogeni.orca.shirako.container.api.ContainerState;
...
import net.exogeni.orca.shirako.kernel.OrcaTick;
import net.exogeni.orca.shirako.kernel.RPCManager;
import net.exogeni.orca.shirako.kernel.interfaces.ITicker;
import net.exogeni.orca.shirako.proxies.ActorLocation;
import net.exogeni.orca.shirako.proxies.ProxyFactory;
import net.exogeni.orca.shirako.proxies.ServiceFactory;
import net.exogeni.orca.shirako.proxies.soapaxis2.SoapAxis2ServletContextInitializer;
import net.exogeni.orca.shirako.registry.ActorRegistry;
import net.exogeni.orca.shirako.time.ActorClock;
import net.exogeni.orca.shirako.util.SpringWSUtils;
...
import net.exogeni.orca.util.OrcaThreadPool;
import net.exogeni.orca.util.PropList;
import net.exogeni.orca.util.ReflectionUtils;
import net.exogeni.orca.util.db.DatabaseBase;
...
public class OrcaContainer <T> implements IActorContainer  {
     ...
     * Registry classes
     */
    protected String defaultRegistryActor = "net.exogeni.orca.shirako.container.RemoteRegistryCache";
...
//Claris: This is a horrible hack to avoid dealing with actor serialization.
    ...
    public void loadConfiguration() throws Exception {
    	...
    	String config = System.getProperty("net.exogeni.orca.config.xml");
    	if (config == null){
	...
	private void writeOrcaStateFile() throws Exception {
		...
		Globals.Log.info("Creating net.exogeni.orca state file");
		state.createStateFile();
	}

	private void removeOrcaStateFile() throws Exception {
		// delete net.exogeni.orca state file
		OrcaState state = OrcaState.getInstance();
		Globals.Log.info("Deleting net.exogeni.orca state file");
