...
/**
 *  FailedRPCResponse bean class
 */
        
public  class FailedRPCResponse
    ...
    public static class Factory{
         ...
         * @param reader reader
         * @return FailedRPCResponse 
         * @throws java.lang.Exception in case of error
         */
        public static FailedRPCResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FailedRPCResponse object = new FailedRPCResponse();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                    ...
                    if (fullTypeName!=null){
                        ...
                        if (!"failedRPCResponse".equals(type)){
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (FailedRPCResponse)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                    nsUri,type,reader);
                        }
