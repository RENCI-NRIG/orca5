...
/**
 *  ExtendLeaseResponse bean class
 */
        
 public  class ExtendLeaseResponse
     ...
     public static class Factory{
          ...
          * @param reader reader
          * @return ExtendLeaseResponse 
          * @throws java.lang.Exception in case of error
          */
         public static ExtendLeaseResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
             ExtendLeaseResponse object = new ExtendLeaseResponse();
             int event;
             try {
                 ...
                 if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                     ...
                     if (fullTypeName!=null){
                         ...
                         if (!"extendLeaseResponse".equals(type)){
                             //find namespace for the prefix
                             java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                             return (ExtendLeaseResponse)net.exogeni.orca.shirako.proxies.soapaxis2.beans.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                         }
