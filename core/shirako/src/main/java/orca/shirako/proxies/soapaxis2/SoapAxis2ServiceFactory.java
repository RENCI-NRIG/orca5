...
public class SoapAxis2ServiceFactory implements IServiceFactory
{
     ...
     */
    public static final String AxisBrokerServiceDescriptor = "orca/shirako/proxies/soapaxis2/deployment/broker.xml";

    /**
     * Location of the broker service descriptor (ws-security enabled).
     */
    public static final String AxisBrokerServiceDescriptorSecure = "orca/shirako/proxies/soapaxis2/deployment/broker.secure.xml";

    /**
     * Location of the authority service descriptor.
     */
    public static final String AxisAuthorityServiceDescrptor = "orca/shirako/proxies/soapaxis2/deployment/authority.xml";

    /**
     * Location of the authority service descriptor (ws-security enabled).
     */
    public static final String AxisAuthorityServiceDescriptorSecure = "orca/shirako/proxies/soapaxis2/deployment/authority.secure.xml";

    /**
     * Location of the service manager service descriptor.
     */
    public static final String AxisServiceManagerServiceDescrptor = "orca/shirako/proxies/soapaxis2/deployment/servicemanager.xml";

    /**
     * Location of the service manager service descriptor (ws-security enabled).
     */
    public static final String AxisServiceManagerServiceDescrptorSecure = "orca/shirako/proxies/soapaxis2/deployment/servicemanager.secure.xml";

    /**
     * Location of the XSL transformation stylesheet. Used to replace security parameters in the service descriptor.
     */
    public static final String TransformTemplate = "orca/shirako/proxies/soapaxis2/deployment/transform.xsl";
    ...
    public File getDescriptor(IActor actor) throws Exception
    {
        ...
        File file = File. createTempFile("orca", "", new File("/tmp"));        
