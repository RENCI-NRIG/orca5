...
import orca.security.AccessDeniedException;
...
import orca.shirako.proxies.soapaxis2.SoapAxis2Return;
import orca.shirako.proxies.soapaxis2.beans.Plist;
import orca.shirako.proxies.soapaxis2.beans.Reservation;
import orca.shirako.proxies.soapaxis2.beans.ResourceSet;
...
public class ActorServiceSkeleton {
    public static final String OrcaSoapFaultNamespace = "http://geni-orca.renci.org/";
    public static final String OrcaSoapFaultPrefix = "orcafault";
    ...
    protected IClientReservation passClient(Reservation reservation) throws Exception {
        ...
        orca.shirako.kernel.ResourceSet rs = Translate.translate(reservation.getResourceSet());
        rs.setResources(getConcrete(reservation));

        return ClientReservationFactory.getInstance().create(new orca.shirako.common.ReservationID(reservation.getReservationID()), rs, Translate.translate(reservation.getTerm()), slice);
    }
    ...
    public orca.shirako.proxies.soapaxis2.services.QueryResponse query(orca.shirako.proxies.soapaxis2.services.Query request) throws RemoteException {
        // authorize
    ...
    public orca.shirako.proxies.soapaxis2.services.QueryResultResponse queryResult(orca.shirako.proxies.soapaxis2.services.QueryResult request) throws RemoteException {
        // authorize
        AuthToken authToken = doAuthorize();
        // extract the request
        IncomingRPC rpc;
    ...
    public orca.shirako.proxies.soapaxis2.services.UpdateLeaseResponse updateLease(orca.shirako.proxies.soapaxis2.services.UpdateLease request) throws RemoteException {
        // authorize
        AuthToken authToken = doAuthorize();
        // extract the request
        IncomingRPC rpc;
    ...
    public orca.shirako.proxies.soapaxis2.services.UpdateTicketResponse updateTicket(orca.shirako.proxies.soapaxis2.services.UpdateTicket request) throws RemoteException {
        // authorize
        AuthToken authToken = doAuthorize();
        // extract the request
...
//                    policy.onUpdateTicket((orca.shirako.core.Ticket) rpc.getReservation().getResources().getResources());
//                }
//            }
//        } catch (Exception e) {
...
//        }
    ...
    public orca.shirako.proxies.soapaxis2.services.FailedRPCResponse failedRPC(orca.shirako.proxies.soapaxis2.services.FailedRPC request) throws RemoteException {
        // authorize
        AuthToken authToken = doAuthorize();
        // extract the request
        IncomingRPC rpc;
