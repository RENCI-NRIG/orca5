...
import orca.extensions.IActorFactory;
...
import orca.manage.beans.PluginCreateMng;
...
import orca.manage.internal.local.LocalContainer;
...
public class ContainerManagementObject extends ManagementObject {
	public ContainerManagementObject() {
		...
		axis2ServiceDescriptor = "orca/manage/extensions/standard/container/proxies/soapaxis2/services/standard.container.xml";
	}
...
//		}
	...
	// CHECKBEFORESHIPPING: move this to the database and generate it at random for each new orca container
