 ...
 *         &lt;element name="reservationId" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetReservationsStateRequest")
public class GetReservationsStateRequest {

    @XmlElement(required = true)
    protected String guid;
    @XmlElement(required = true)
    protected AuthTokenMng auth;
    protected List<String> reservationId;
    ...
    public List<String> getReservationId() {
        if (reservationId == null) {
            reservationId = new ArrayList<String>();
        }
