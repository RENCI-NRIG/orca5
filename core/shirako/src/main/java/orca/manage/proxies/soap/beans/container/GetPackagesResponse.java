 ...
 *         &lt;element name="packages" type="{http://www.nicl.duke.edu/orca/manage/beans}packageMng" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetPackagesResponse {
    ...
    protected List<PackageMng> packages;
    ...
    public List<PackageMng> getPackages() {
        if (packages == null) {
            packages = new ArrayList<PackageMng>();
        }
