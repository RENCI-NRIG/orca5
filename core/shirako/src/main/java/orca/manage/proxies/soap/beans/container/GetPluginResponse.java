 ...
 *         &lt;element name="plugin" type="{http://www.nicl.duke.edu/orca/manage/beans}pluginMng"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetPluginResponse")
public class GetPluginResponse {

    @XmlElement(required = true)
    protected ResultMng status;
    @XmlElement(required = true)
    protected PluginMng plugin;
     ...
     *     
     */
    public void setPlugin(PluginMng value) {
        this.plugin = value;
    }
