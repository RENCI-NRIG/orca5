 ...
 *         &lt;element name="reservationState" type="{http://www.nicl.duke.edu/orca/manage/beans}reservationStateMng"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetReservationStateResponse")
public class GetReservationStateResponse {

    @XmlElement(required = true)
    protected ResultMng status;
    @XmlElement(required = true)
    protected ReservationStateMng reservationState;
     ...
     *     
     */
    public ReservationStateMng getReservationState() {
     ...
     *     
     */
    public void setReservationState(ReservationStateMng value) {
