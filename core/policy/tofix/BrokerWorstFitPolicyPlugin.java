...
/**
 * The <code> AgentWorstFitPolicyPlugin</code> performs a worst fit allocation
 ...
 * @author grit
 */
public class BrokerWorstFitPolicyPlugin extends BrokerPriorityPolicy
{
    /**
     * Properties appended to each donated reservation to indicate the ids used
     * for nodes provided by this reservation
     */
     ...
     */
    public static String PropertyIDs = "AgentWorstFitPolicyPluginIDs";
    ...
    public void donate(ReservationClient r) throws Exception
    {
        ...
        /*
         * aydan: What if this ticket was an extend?
         */
    ...
    protected long checkRequestEndTime(long[] maxResources, long start, long end,
                                       BrokerReservation r) throws Exception
    {
        return end;
    }
        ...
        if (requests != null) {
            ...
            while (i.hasNext()) {
                ...
                if (!r.isExtendingTicket() && !r.isClosed()) {
                    ...
                    /*
                     * Check to see if the request arrived late but can be
                     * shifted to start at this allocation cycle.
                     */
                    if ((start < startCycle) &&
                            PropertiesManager.isElasticTime(r.getRequestedResources())) {
                        long length = end - start;
                        start = startCycle;
                        end = startCycle + length;
                    }
    ...
    protected void storeIDList(ReservationClient r, ArrayList<ID> list)
    {
        String str = getIDString(list);
        Properties p = r.getLocalProperties();
    ...
    protected String getIDString(ArrayList<ID> list)
    {
        StringBuffer sb = new StringBuffer();
    ...
    protected ArrayList<ID> getIDList(ReservationClient r)
    {
    ...
    protected ArrayList<ID> getIDList(String str)
    {
    ...
    public void revisit(ResourceReservation reservation) throws Exception
    {
        ...
        if (reservation instanceof ReservationClient) {
        }
    }
