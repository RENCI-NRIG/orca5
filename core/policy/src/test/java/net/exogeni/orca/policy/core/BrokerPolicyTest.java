...
import net.exogeni.orca.policy.core.util.DummyAuthorityProxy;
...
public abstract class BrokerPolicyTest extends OrcaTestCase {
    ...
    protected IAuthorityProxy getAuthorityProxy() {
        ...
        IAuthorityProxy proxy = new SoapAxis2AuthorityProxy("http://my.container/net.exogeni.orca:8080/services/mysite", auth, Globals.Log);
