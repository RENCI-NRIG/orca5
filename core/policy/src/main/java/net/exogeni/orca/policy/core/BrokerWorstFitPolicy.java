...
import net.exogeni.orca.policy.core.util.AllotmentEntry;
import net.exogeni.orca.policy.core.util.AllotmentTable;
import net.exogeni.orca.policy.core.util.LogicalInventory;
import net.exogeni.orca.policy.core.util.MachineState;
import net.exogeni.orca.policy.core.util.ResourceEntry;
import net.exogeni.orca.policy.core.util.ResourceProperties;
import net.exogeni.orca.policy.core.util.ResourceTable;
