...
import orca.util.db.beans.Mapping;
...
public class MySqlPropertiesMapper extends PropertiesMapper
{
    ...
    protected void createMapping() throws Exception
    {
        ...
        while (iter.hasNext()) {
            orca.util.db.beans.Mysqlentry entry = (orca.util.db.beans.Mysqlentry) iter.next();
            ...
            while (i.hasNext()) {
                orca.util.db.beans.Map m = (orca.util.db.beans.Map) i.next();
    ...
    protected Mapping readMysqlMapping() throws IOException, JAXBException
    {
        ...
        JAXBContext context = JAXBContext.newInstance("orca.util.db.beans");
