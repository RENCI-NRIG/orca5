...
public class BenSimpleControllerFactory extends BenControllerFactory{
    @Override
    protected BenController makeController() {
        return new BenSimpleController();
    }
    
    @Override
    protected BenControllerManagerObject makeManagerObject() {
        return new BenSimpleControllerManagerObject(cont, actor);
    }
    
    @Override
    public String getPortalPluginClassName() {
        return BenSimpleControllerPortalPlugin.class.getCanonicalName();
    }
}
