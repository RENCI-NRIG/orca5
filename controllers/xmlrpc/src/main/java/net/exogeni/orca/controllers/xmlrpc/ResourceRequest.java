...
public class ResourceRequest {
    ...
    /*
     * WRITEME: there are a number of ways to implement these methods: 1. Make individual getReservation calls to get
     * the most recent reservation state. 2. Add a lighter weight getReservationState that returns the reservation state
     * only [this is good anyway] 3. Add boolean isActive(List<ReservationID>) boolean isTerminal(List<ReseravtionID>)
     * boolean isClosed(List<ReservationID>) boolean hasAtLeastOneTerminatl(List<ReservationID>) boolean
     * hasAtLeastOneFailed(List<ReservationID>)
     * 
