...
public interface IGeniAmV2Interface {
    ...
    public enum ApiReturnFields {
        GENI_API("geni_api"), CODE("code"), CODE_GENI_CODE("geni_code"), CODE_AM_TYPE("am_type"), CODE_AM_CODE(
                "am_code"), VALUE("value"), VALUE_API_VERSIONS("geni_api_versions"), VALUE_API_VERSIONS_URL(
                        "URL"), VALUE_REQ_RSPEC_VERSIONS("geni_request_rspec_versions"), VALUE_AD_RSPEC_VERSIONS(
                                "geni_ad_rspec_versions"), VALUE_RSPEC_TYPE(
                                        "type"), VALUE_RSPEC_VERSION("version"), VALUE_RSPEC_SCHEMA(
                                                "schema"), VALUE_RSPEC_NAMESPACE("namespace"), VALUE_RSPEC_EXTENSIONS(
                                                        "extensions"), OUTPUT("output"), GENI_URN(
                                                                "geni_urn"), GENI_STATUS("geni_status"), GENI_RESOURCES(
                                                                        "geni_resources"), GENI_ERROR(
                                                                                "geni_error"), GENI_AM_TYPE(
                                                                                        "geni_am_type"),

        ORCA_EXPIRES("orca_expires"), ORCA_VERSION("orca_version");
    ...
    public enum ApiOptionFields {
        // for list resources
        GENI_COMPRESSED("geni_compressed"), GENI_SLICE_URN("geni_slice_urn"), GENI_RSPEC_VERSION("geni_rspec_version"),
    ...
    public enum GeniStates {
        CONFIGURING("configuring"), READY("ready"), FAILED("failed"), UNKNOWN("unknown");
    ...
    public enum ApiReturnCodes {
        SUCCESS(0), BADARGS(1), ERROR(2), FORBIDDEN(3), BADVERSION(4), SERVERERROR(5), TOOBIG(6), REFUSED(7), TIMEDOUT(
                8), DBERROR(9), RPCERROR(10), UNAVAILABLE(11), SEARCHFAILED(
                        12), UNSUPPORTED(13), BUSY(14), EXPIRED(15), INPROGRESS(16), ALREADYEXISTS(17);
    ...
    // public Map<String, Object> CreateSliver(String slice_urn, Object[] credentials, String resReq, List<Map<String,
    // ?>> users);
