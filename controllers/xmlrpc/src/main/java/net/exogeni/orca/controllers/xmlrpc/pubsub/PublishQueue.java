...
public final class PublishQueue implements Serializable {
    ...
    private Set<SliceState> slicesToWatch = new HashSet<SliceState>(); // slices to watch for the publisher state
                                                                       // machine
    ...
    /**
     * Any deleted slices accumulated on deleted slices Q get dealt with here
     */
    ...
    /**
     * Any new slices accumulated on new slices Q get dealt with here
     */
