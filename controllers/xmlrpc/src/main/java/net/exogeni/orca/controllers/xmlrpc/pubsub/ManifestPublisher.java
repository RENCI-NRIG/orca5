...
public class ManifestPublisher {
    ...
    public void prepareXMPP() throws Exception {
        ...
        if ((xmppServerPort == null) || (xmppLogin == null) || (xmppPassword == null)) {
        ...
        if ((xmppUseCertificate == null) || (xmppUseCertificate.equalsIgnoreCase("false"))) {
            ...
            if ((kspath == null) || (kstype == null) || (tspath == null)) {
                throw new Exception(
                        "Missing keystore path, keystore type or truststore path for certificate based login");
            }

            xps = new XMPPPubSub(xmppServerPort.split(":")[0], port, xmppLogin, xmppPassword, kspath, kstype, tspath,
                    tspass, logger, null);
            ...
            throw new Exception(
                    "Certificate usage property has to be specified as: pubsub.usecertificate=[true|false]");
        }
    }
    ...
    public void createAccountAndDisconnect() throws Exception {
        ...
        if ((xmppServerPort == null) || (xmppLogin == null)) {
        ...
        XMPPPubSub xmppAcctCreation = new XMPPPubSub(xmppServerPort.split(":")[0], port, xmppLogin, defaultPassword,
                logger, null);
    ...
    public void publishManifest(String actor_id, String slice_id, String manifest) {
        ...
        if (actor_id == null || slice_id == null || manifest == null) {
            logger.error(
                    "publishManifest(): At least one of actor_id, slice_id, manifest is null; Can't publish manifest");
            return;
        }
        ...
        String base64EncodedZippedManifest = net.exogeni.orca.util.CompressEncode.compressEncode(manifest);
    ...
    public void publishSliceList(String actor_id, String sliceListString) {
        ...
        if (actor_id == null || sliceListString == null) {
            logger.error(
                    "publishSliceList(): At least one of actor_id, sliceListString is null; Can't publish sliceList");
            return;
        }
    ...
    public void expungeNode(String actor_id, String slice_id, String suffix) {
        ...
        if (actor_id == null || slice_id == null || suffix == null) {
            logger.error(
                    "expungeNode(): At least one of actor_id, slice_id, suffix is null; Can't expunge xmpp pubsub node");
            return;
        }
