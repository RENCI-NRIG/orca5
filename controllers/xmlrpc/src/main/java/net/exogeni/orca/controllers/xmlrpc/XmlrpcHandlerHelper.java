...
import net.exogeni.orca.controllers.xmlrpc.x509util.CertificateUtil;
import net.exogeni.orca.controllers.xmlrpc.x509util.Credential;
import net.exogeni.orca.controllers.xmlrpc.x509util.CredentialValidator;
import net.exogeni.orca.controllers.xmlrpc.x509util.Gid;
...
import net.exogeni.orca.controllers.xmlrpc.geni.GeniAmV2Handler;
import net.exogeni.orca.controllers.xmlrpc.geni.IGeniAmV2Interface.ApiOptionFields;
...
public class XmlrpcHandlerHelper {
    ...
    public static Date validateGeniCredential(String sliceUrn, Object[] credentials, String[] requiredPrivilege,
        ...
        if (options != null) {
            spoken_for_user_urn = (String) options.get(IGeniAmV2Interface.ApiOptionFields.GENI_SPEAKING_FOR.name);
