...
import net.exogeni.orca.embed.workflow.ModifyReservations;
...
import net.exogeni.orca.ndl.elements.RequestSlice;
...
public class ReservationConverter implements LayerConstant {
    ...
    public HashMap<String, ReservationRequest> formReservations(IOrcaServiceManager sm,
        ...
        for (NetworkElement device : boundElements) {
            ...
            if (resrequest.isNetwork) {
                ...
                if (rSlice != null) {
                    logger.debug("OF Slice:" + rSlice.getOfCtrlUrl() + ":" + rSlice.getOfUserEmail() + ":"
    ...
    public void updateGeniStates(OntModel manifestModel, IGeniAmV2Interface.GeniStates geniStates) {
    ...
    public OntModel getManifestModel(OntModel manifestModel, LinkedList<OntResource> domainInConnectionList,
        ...
        for (i = 0; i < domainInConnectionList.size(); i++) {
            ...
            for (int j = 0; j < allRes.size(); j++) {
                ...
                // logger.info("getManifest: domain=" + domain_ont.getURI() + " ;aDomian = "+domain+" :rDomain=" +
                // rDomain +" rType="+rType);
