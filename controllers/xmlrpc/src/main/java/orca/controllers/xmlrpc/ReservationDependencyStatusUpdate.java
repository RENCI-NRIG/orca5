	...
	public void success(List<ReservationID> ok, List<ReservationID> actOn)
		...
		try {
			...
			if(p_str!=null){
				...
				System.out.println("Number of new parent reservations:"+p+";num_interface="+num_interface_int+";num_storage="+num_storage_int);
				for(int i=0;i<p;i++){
			...
			if(e_p_str!=null){
				...
				System.out.println("Number of existing parent reservations:"+p+";num_interface="+num_interface_int+";num_storage="+num_storage_int);
				for(int i=0;i<p;i++){
