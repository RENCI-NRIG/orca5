...
public class OrcaRegressionTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                ...
                { "../../embed/src/test/resources/orca/embed/TS2/TS2-8.rdf", true, 4 - 1 }, // Shared VLAN does not
                                                                                            // count as reservation.
                { "../../embed/src/test/resources/orca/embed/TS2/TS2-9.rdf", true, 3 - 1 + 1 }, // StitchPort does not
                                                                                                // count as reservation
                ...
                { "../../embed/src/test/resources/orca/embed/TS2/TS2-13.rdf", true, 5 - 2 }, // two stitchingports on
                                                                                             // different vlans to a
                                                                                             // node on two seperate
                                                                                             // two-end broadcast links
                { "../../embed/src/test/resources/orca/embed/TS2/TS2-14.rdf", true, 10 - 1 }, // more than 2 mixed
                ...
                { "../../embed/src/test/resources/orca/embed/TS3/TS3-3.rdf", true, 13 + 12 }, // 13 in request + 12
                ...
                { "../../embed/src/test/resources/orca/embed/TS3/TS3-14.rdf", true, 99 + 5 }, // Works here, maybe not
                                                                                              // correctly in ExoSM.
                ...
                // { "../../embed/src/test/resources/orca/embed/TS7/TS7-1.rdf", true, 14-1+11}, // Deprecated. OSG site
                // no longer exists
                { "../../embed/src/test/resources/orca/embed/request-stitchport-URLcham-TAG3291-3292.rdf", true,
                        3 - 2 + 4 },
