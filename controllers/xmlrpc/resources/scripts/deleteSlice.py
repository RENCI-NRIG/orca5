...
print "Contacting ORCA xml-rpc server to delete the sliver... \n"
...
print "Waiting for slivers in slice " + sliceID + " to be deleted... \n"

credentials = []
result = server.orca.deleteSlice(sliceID, credentials)

print result

if result['err'] == False and result['ret'] == True:
	print "*** Sliver deletion successful"
else:
	print "*** Could not delete sliver"
