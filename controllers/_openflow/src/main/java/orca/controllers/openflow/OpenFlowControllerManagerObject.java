...
public class OpenFlowControllerManagerObject extends ControllerManagerObject {
    ...
    protected void registerProtocols() {
        OrcaProxyProtocolDescriptor p = new OrcaProxyProtocolDescriptor(ManageExtensionsApiConstants.ProtocolLocal, LocalOpenFlowControllerManagementProxy.class.getCanonicalName());
