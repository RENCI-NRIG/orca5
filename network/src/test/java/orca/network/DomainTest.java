...
public class DomainTest extends TestCase {
	...
	String [] inputFileName={"orca/network/dukevmsite.rdf","orca/network/rencivmsite.rdf",
			"orca/network/uncvmsite.rdf","orca/network/mass.rdf",
			"orca/network/ben-6509.rdf",
			"orca/network/nlr.rdf","orca/network/starlight.rdf",
			"orca/network/dukeNet.rdf","orca/network/renciNet.rdf","orca/network/uncNet.rdf"};
