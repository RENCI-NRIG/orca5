...
public final class NetworkConnection extends NetworkElement {
	...
	private LinkedList <NetworkConnection> clientConnections=new LinkedList<NetworkConnection>(); //client connections adapted
	...
	public int compareTo(Object o) {
		...
		if(this.bandwidth<ne.getBandwidth()) compare=1;
		else if(this.bandwidth>ne.getBandwidth()) compare=-1;
	...
	public void print(Logger logger){
		NetworkElement ne;
		logger.info(connectionType+":"+ne1.getName()+":"+ne1.getNumUnits()+"-"+ne2.getName()+":"+ne2.getNumUnits()+":"+bandwidth);
		Iterator<NetworkElement> it=connection.iterator();
		while(it.hasNext()){
			ne=(NetworkElement) it.next();
			ne.print(logger);
