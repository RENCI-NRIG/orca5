...
public class IPAddress extends Label {
    ...
    public IPAddress getNewIpAddress(OntModel om, String start_ip, String netmask, String label_uri, int i)
    ...
    public static boolean validateIP(String ip) {
        ...
        if (m.find()) {
            ...
            return checkOctet(m.group(1)) && checkOctet(m.group(2)) && checkOctet(m.group(3)) && checkOctet(m.group(4));
        }
        return false;
    }
