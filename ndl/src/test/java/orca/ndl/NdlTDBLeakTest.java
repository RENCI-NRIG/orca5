...
public class NdlTDBLeakTest
        implements INdlManifestModelListener, INdlRequestModelListener, INdlAbstractDelegationModelListener {
    ...
    public void ndlNetworkDomain(Resource dom, OntModel m, List<Resource> netServices, List<Resource> interfaces,
    ...
    private void runM(String reqFile) throws NdlException, FileNotFoundException {
        ...
        NdlManifestParser mp = new NdlManifestParser(r, this, NdlModel.ModelType.TdbPersistent,
                "/tmp/tdb/" + UUID.randomUUID());
        mp.processManifest();
        mp.freeModel();
    }
    ...
    private void runA(String reqFile) throws NdlException, FileNotFoundException {
        ...
        while (!done) {
            ...
            // parse out
            NdlAbstractDelegationParser nadp = new NdlAbstractDelegationParser(ad, this,
                    NdlModel.ModelType.TdbPersistent, "/tmp/tdb/" + UUID.randomUUID());
    ...
    private void runR(String reqFile) throws NdlException, FileNotFoundException {
        ...
        NdlRequestParser rp = new NdlRequestParser(r, this, NdlModel.ModelType.TdbPersistent,
                "/tmp/tdb/" + UUID.randomUUID());
        rp.processRequest();
        rp.freeModel();
    }
