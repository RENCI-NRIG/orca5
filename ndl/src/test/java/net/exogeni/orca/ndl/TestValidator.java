...
import net.exogeni.orca.ndl.NdlModel.LocatorJarURL;
...
public class TestValidator {
    ...
    // protected String[] inferenceModels = { "topology.owl", "storage.owl", "compute.owl", "geni.owl",
    // "eucalyptus.owl", "planetlab.owl", "protogeni.owl", "ec2.owl", "exogeni.owl"};
