...
public class OntProcessorTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        inputFileName = "net.exogeni.orca/ndl/substrate/ben-6509.rdf";
    ...
    public void testListProperty() {
        ...
        String uri = "http://geni-net.exogeni.orca.renci.org/owl/ben.rdf#Renci/Cisco/6509";
    ...
    public void testGetLayer() {
        ...
        String uri = "http://geni-net.exogeni.orca.renci.org/owl/ben-dtn.rdf#Duke/Infinera/DTN/fB/1/ocgB/1";
    ...
    public void testConnectedTo() {
        ...
        String url1 = "http://geni-net.exogeni.orca.renci.org/owl/ben-6509.rdf#Renci/Cisco/6509/TenGigabitEthernet/3/1/fiber";
    ...
    public void testListResourceInModel() {
        ...
        String device = "http://geni-net.exogeni.orca.renci.org/owl/ben.rdf#Renci/Cisco/6509";
    ...
    public void testGetConnectionSubGraphSwitchedTo() {
        ...
        String url1 = "http://geni-net.exogeni.orca.renci.org/owl/ben-6509.rdf#Duke/Cisco/6509/TenGigabitEthernet/2/1/fiber";

        String selectStr = "SELECT ?intf ?p ?a ?intf_peer ?b ";
        String fromStr = "";
        String whereStr = "WHERE {" + "?p a layer:AdaptationProperty. " + "<" + url1 + ">" + " ndl:linkTo ?intf. "
                + "?intf ?p ?a." + "?inf_peer layer:switchedTo ?b " + "      }";
        ...
        url1 = "http://geni-net.exogeni.orca.renci.org/owl/ben.rdf#Renci/Polatis";
        String url2 = "http://geni-net.exogeni.orca.renci.org/owl/ben.rdf#Duke/Polatis";
        String s = "SELECT ?a ?b ?c ";
        String f = "";
        String w = "WHERE {" + "?p a layer:AdaptationProperty." + "(<" + url1 + "> '[ndl:hasInterface]+/[ndl:linkTo]+/["
                + "?p" + "]*/[layer:switchedTo]*/[ndl:interfaceOf]+)+' <" + url2 + ">) gleen:Subgraph (?a ?b ?c)"
                + "      }";
    ...
    public void testListConnectedDevice() {
        ...
        String url1 = "http://geni-net.exogeni.orca.renci.org/owl/ben-6509.rdf#Renci/Cisco/6509/TenGigabitEthernet/3/7/fiber";
        String url2 = "http://geni-net.exogeni.orca.renci.org/owl/ben-6509.rdf#UNC/Cisco/6509/TenGigabitEthernet/3/7/fiber";
    ...
    public void testGetSwitchedToAdaptation() {
        ...
        OntModel model = ontProcessor.getOntModel();
        String url1 = "http://geni-net.exogeni.orca.renci.org/owl/ben-6509.rdf#Renci/Cisco/6509";
    ...
    public void testFindShortestPath() {
        ...
        String url1 = "http://geni-net.exogeni.orca.renci.org/owl/ben-6509.rdf#Renci/Cisco/6509/TenGigabitEthernet/3/7/fiber";
        String url2 = "http://geni-net.exogeni.orca.renci.org/owl/ben-6509.rdf#UNC/Cisco/6509/TenGigabitEthernet/3/7/fiber";
        ArrayList<ArrayList<OntResource>> path = ontProcessor.findShortestPath(model, model.getOntResource(url1),
                model.getOntResource(url2), 100000, "VM", "VM", null);
