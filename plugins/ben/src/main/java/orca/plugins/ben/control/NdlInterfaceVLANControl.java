        ...
        if (current == null) {
            ...
            if (tags.getFree() > 0) {
                if (staticTag != null) {
                    ...
                    if (drs == null) {
                    	throw new Exception("NdlInterfaceVLANControl.assign(): DomainResources is null, unable to proceed");
                    }
                    ...
                    if (bit_set != null) {
                        ...
                        tag = tags.allocate();
                    logger.debug("NdlInterfaceVLANControl.assign(): assigned tag=" + tag + "intf1=" + edge_intf_1_str + ";intf2="
                            + edge_intf_2_str);
                }
