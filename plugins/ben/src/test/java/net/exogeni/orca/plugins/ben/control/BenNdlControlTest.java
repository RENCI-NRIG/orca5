...
import net.exogeni.orca.policy.core.AuthorityCalendarPolicyTest;
...
public class BenNdlControlTest extends AuthorityCalendarPolicyTest
    ...
    public static final String SubstrateFile = "net.exogeni.orca/network/ben-dell.rdf";

    public static final String RequestFile = "net.exogeni.orca/network/request-6509.rdf";
