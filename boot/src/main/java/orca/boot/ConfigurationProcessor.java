...
import orca.boot.beans.Control;
import orca.boot.beans.Edges;
import orca.boot.beans.Handler;
import orca.boot.beans.Pool;
import orca.boot.beans.Pools;
import orca.boot.beans.Rset;
import orca.boot.beans.Vertex;
import orca.boot.inventory.PoolCreator;
...
import orca.policy.core.BrokerSimplerUnitsPolicy;
import orca.policy.core.IResourceControl;
import orca.policy.core.ServiceManagerSimplePolicy;
...
import orca.shirako.plugins.substrate.Substrate;
import orca.shirako.plugins.substrate.db.SubstrateActorDatabase;
import orca.shirako.proxies.Proxy;
import orca.shirako.proxies.local.LocalAuthority;
import orca.shirako.proxies.local.LocalBroker;
import orca.shirako.proxies.soapaxis2.SoapAxis2AuthorityProxy;
import orca.shirako.proxies.soapaxis2.SoapAxis2BrokerProxy;
...
public class ConfigurationProcessor {
    ...
    public void process() throws ConfigurationException {
        try {
            ...
            initializeActors();
            logger.info(" +++++ There are " + orca.shirako.core.Actor.actorCount + " actors");
            ...
            processTopology();
            /* process any exports */
            logger.info(" +++++ Processing exports with actor count " + orca.shirako.core.Actor.actorCount);
            processExports();
    ...
    protected IPolicy makePolicy(orca.boot.beans.Policy policy) throws ConfigurationException {
        IPolicy result = null;
