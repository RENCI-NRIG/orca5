...
import net.exogeni.orca.boot.beans.*;
import net.exogeni.orca.boot.beans.CryptoKey;
import net.exogeni.orca.boot.beans.Instance;
import net.exogeni.orca.boot.beans.Parameter;
import net.exogeni.orca.boot.beans.Rdata;
import net.exogeni.orca.boot.beans.Rset;
import net.exogeni.orca.boot.beans.SimpleParameter;
import net.exogeni.orca.boot.beans.SimpleParameters;
import net.exogeni.orca.shirako.api.IObjectFactory;
...
public class ConfigurationTools {
    ...
    public static java.util.Properties getProperties(net.exogeni.orca.boot.beans.Properties beanProperties) {
        ...
        if (beanProperties != null) {
            ...
            if (beanPropertyArray != null) {
                for (int i = 0; i < beanPropertyArray.length; i++) {
                    Property prop = (Property) beanPropertyArray[i];
